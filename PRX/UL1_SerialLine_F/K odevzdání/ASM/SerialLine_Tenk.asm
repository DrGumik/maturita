...
start:						; >> Inicializace
	...
	clr R17					; >> Vynulov�n� registr� R17-R24
	clr R18
	clr R19
	clr R20
	clr R21
	...
	jmp main				; >> Skok do hlavn�ho cyklu
...
init_timer0: 				; >> HW Delay (+- 2ms)
	...
	out OCR0, temp  		; >> Nastaven� kompara�n� hodnoty
	ret

get_key:
	lds temp, UDR1			; >> P�e�ten� data z UDR1 do reg. temp
	
	mov R24, R23			; >> Posunut� "znaku na displeji" sm�rem do prava
	mov R23, R22
	mov R22, R21
	mov R21, R20
	mov R20, R19
...
compare_time:  
	...
	jmp compare_time		; >> TIFR a vrac� se do hlavn�ho programu
	ret
