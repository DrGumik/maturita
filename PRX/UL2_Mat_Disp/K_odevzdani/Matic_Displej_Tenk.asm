...
timer0_int:
	; >> Posunutí ukazatele na další sadu vzorù
	sbrs canStart, 0
	jmp int_return
...
tick:
	...
	; >> Nastaví ukazatel na zaèátek sady vzorù
	ld temp, X
	mov R28, temp ; >> set YL
	ldi YH, 0x05
...
; >> Vzory pro daný sloupec klávesnice s poètem kláves ve sloupci
...
; >> Podporovaná tlaèítka: 1, 2, 3, 4, 5, 6, 7, 8, 9
; >> Tlaèítko 9 spouští promítání na displeji
